    ...
    var BertTokenizer = (function () {
        ...
        BertTokenizer.prototype.tokenize = function (text) {
            ...
            for (var i = 0; i < words.length; i++) {
                var chars = [];
                try {
                    for (var _b = (e_4 = void 0, __values(words[i].text)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var symbol = _c.value;
                        chars.push(symbol);
                    }
                }
        ...
        QuestionAndAnswerImpl.prototype.getBestAnswers = function (startLogits, endLogits, origTokens, tokenToOrigMap, context, docIndex) {
            ...
            for (var i = 0; i < origResults.length; i++) {
                ...
                if (origResults[i].start > 0) {
                    _a = __read(this.convertBack(origTokens, tokenToOrigMap, origResults[i].start, origResults[i].end, context), 3), convertedText = _a[0], startIndex = _a[1], endIndex = _a[2];
                }
                else {
                    convertedText = '';
                }
